...
///////////////////////////////////////
// const recipe = fetch("https://forkify-api.herokuapp.com/v2");
// console.log(recipe);
    ...
    const markup = `
      ...
      <div class="recipe__details">
        ...
        <div class="recipe__info">
          ...
          <span class="recipe__info-data recipe__info-data--people">${recipe.cookingTime}</span>
...
// const showPizzaRecipe = async function () {
//     try {
//         let res = await fetch("https://forkify-api.herokuapp.com/api/v2/recipes/5ed6604591c37cdc054bcd09");

//         let data = await res.json();
//         let { recipe1 } = data.data;
//         recipe1 = {
//             id: recipe1.id,
//             title: recipe1.title,
